...
void GuiManager::Draw(WGPURenderPassEncoder render_pass)
{
    ...
    */
    ...
    if (ImGui::BeginPopup("Bed-SubMenu"))
    {
        ...
        {                                                          // DO NOT PUT THIS else MULTIPLE TIMES, JUST THIS RIGHT HERE IS ENOUGH
        ...
        if (ImGui::IsItemHovered())
        {   // allows user to preview the decor before the purchase it!
        ...
        //------------------Gym Rat----------------------------------
        if (isPurchased("gymratbed") == false)
        {
            if (ImGui::Button("Gym-Rat-Bed 1300$"))
            {
                if (ECS.Get<EntityManager::Money>(0).price >= 1900)
                {
                    ECS.Get<GraphicsManager::Sprite>(2).image_name = "gymratbed";
                    printf("changed to Gym Rat Bed");
                    temp = "gymratbed";
                    ECS.Get<EntityManager::Money>(0).price -= 1900;
                    purchasedItems.push_back("gymratbed");
                    PurchasedItemSound();
                }
            }
        }
        ...
        //---------------------Anime---------------------------
        if (isPurchased("animebed") == false)
        {
            if (ImGui::Button("Anime-Bed 1800$"))
            {
                if (ECS.Get<EntityManager::Money>(0).price >= 1900)
                {
                    ECS.Get<GraphicsManager::Sprite>(2).image_name = "animebed";
                    printf("changed to anime bed");
                    temp = "animebed";
                    ECS.Get<EntityManager::Money>(0).price -= 1900;
                    purchasedItems.push_back("animebed");
                    PurchasedItemSound();
                }
            }
        }
    ...
    if (ImGui::BeginPopup("Lamp-SubMenu"))
    {
        ...
        {
            if (ImGui::Button("Patriot-Lamp 500$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Rich-B**** Lamp 590$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Gaming-Lamp 550$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Stoner-Lamp 560$"))
            { // sahdai
        ...
        {
            if (ImGui::Button("Halloween-Lamp 600$"))
            { // shadai
                // jackolantern
        ...
        //----------------Christmas---------------------------
        if (isPurchased("christmaslamp") == false)
        {
            if (ImGui::Button("Christmas-Lamp 600$"))
            {
                if (ECS.Get<EntityManager::Money>(0).price >= 600)
                {
                    ECS.Get<GraphicsManager::Sprite>(3).image_name = "christmaslamp";
                    printf("changed to Christmas lamp");
                    temp2 = "christmaslamp";
                    ECS.Get<EntityManager::Money>(0).price -= 600;
                    purchasedItems.push_back("christmaslamp");
                    PurchasedItemSound();
                }
            }
        }
        ...
        //------------------Gym Rat----------------------------------
        if (isPurchased("gymratlamp") == false)
        {
            if (ImGui::Button("Gym-Rat-Lamp 500$"))
            {
                if (ECS.Get<EntityManager::Money>(0).price >= 500)
                {
                    ECS.Get<GraphicsManager::Sprite>(3).image_name = "gymratlamp";
                    printf("changed to Gym Rat Lamp");
                    temp2 = "gymratlamp";
                    ECS.Get<EntityManager::Money>(0).price -= 500;
                    purchasedItems.push_back("gymratlamp");
                    PurchasedItemSound();
                }
            }
        }
        ...
        //---------------------Anime---------------------------
        if (isPurchased("animelamp") == false)
        {
            if (ImGui::Button("Anime Lamp 520$"))
            { // shadai
                if (ECS.Get<EntityManager::Money>(0).price >= 520)
                {
                    printf("changed to anime lamp");
                    ECS.Get<GraphicsManager::Sprite>(3).image_name = "animelamp";
                    temp2 = "animelamp";
                    ECS.Get<EntityManager::Money>(0).price -= 520;
                    purchasedItems.push_back("animelamp");
                    PurchasedItemSound();
    ...
    if (ImGui::BeginPopup("Desk-SubMenu"))
    {
        ...
        {
            if (ImGui::Button("Patriot-Desk 800$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Rich-B*****-Desk 850$"))
            { // shadai
                /*
        ...
        {
            if (ImGui::Button("Gaming-Desk-I 950$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Gaming-Desk-II 875$"))
            { // shadai
                // Console
        ...
        if (isPurchased("richdesk") == false)
        {
            if (ImGui::Button("Rainbow-Desk 860$"))
            { // shadai
                /*
                if(ECS.Get<EntityManager::Money>(0).price >=850){
        ...
        //------------------Christmas Desk----------------
        if (isPurchased("christmasdesk") == false)
        {
            if (ImGui::Button("Christmas Desk 1000$"))
            { // shadai
                // Console
                if (ECS.Get<EntityManager::Money>(0).price >= 1000)
                {
                    printf("changed to gaming desk2");
                    ECS.Get<GraphicsManager::Sprite>(4).image_name = "christmasdesk";
                    temp3 = "christmasdesk";
                    ECS.Get<EntityManager::Money>(0).price -= 1000;
                    purchasedItems.push_back("christmasdesk");
                    PurchasedItemSound();
                }
            }
        }
        ...
        if (isPurchased("gymratdesk") == false)
        {
            if (ImGui::Button("Gym-Rat Desk 900$"))
            { // shadai
                // Console
                if (ECS.Get<EntityManager::Money>(0).price >= 900)
                {
                    printf("changed to gaming desk2");
                    ECS.Get<GraphicsManager::Sprite>(4).image_name = "gymratdesk";
                    temp3 = "gymratdesk";
                    ECS.Get<EntityManager::Money>(0).price -= 900;
                    purchasedItems.push_back("gymratdesk");
                    PurchasedItemSound();
                }
            }
        }
        ...
        if (isPurchased("animedesk") == false)
        {
            if (ImGui::Button("Anime Desk 920$"))
            { // shadai
                // Console
                if (ECS.Get<EntityManager::Money>(0).price >= 920)
                {
                    printf("changed to gaming desk2");
                    ECS.Get<GraphicsManager::Sprite>(4).image_name = "animedesk";
                    temp3 = "animedesk";
                    ECS.Get<EntityManager::Money>(0).price -= 920;
                    purchasedItems.push_back("animedesk");
                    PurchasedItemSound();
                }
            }
        }
    ...
    if (ImGui::BeginPopup("Dresser-SubMenu"))
    {
        ...
        {
            if (ImGui::Button("Patriot-Dresser 700$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Rich-Snitch-Dresser 790$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Gaming-Dresser-I 750$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Rainbow-Dresser 750$"))
            { // shadai
                /*if(ECS.Get<EntityManager::Money>(0).price >=750){
        ...
        {
            if (ImGui::Button("Goth-Dresser 780$"))
            { // shadai
        ...
        {
            if (ImGui::Button("Halloween-Dresser 800$"))
            { // shadai
                /*if(ECS.Get<EntityManager::Money>(0).price >=800){
                           printf("changed to rainbow dresser");
                           ECS.Get<GraphicsManager::Sprite>(5).image_name = "hallowdresser";
        ...
        //----------christmas------------
        if (isPurchased("christmasdresser") == false)
        {
            if (ImGui::Button("Christmas Dresser 800$"))
            { 
                if (ECS.Get<EntityManager::Money>(0).price >= 800)
                {
                    ECS.Get<GraphicsManager::Sprite>(5).image_name = "christmasdresser";
                    printf("changed to gaming Desk");
                    temp4 = "christmasdresser";
                    ECS.Get<EntityManager::Money>(0).price -= 800;
                    purchasedItems.push_back("christmasdresser");
                    PurchasedItemSound();
                }
            }
        }
        ...
        if (isPurchased("gymratdresser") == false)
        {
            if (ImGui::Button("Gym-Rat Dresser 750$"))
            { 
                if (ECS.Get<EntityManager::Money>(0).price >= 750)
                {
                    ECS.Get<GraphicsManager::Sprite>(5).image_name = "gymratdresser";
                    printf("changed to gaming Desk");
                    temp4 = "gymratdresser";
                    ECS.Get<EntityManager::Money>(0).price -= 750;
                    purchasedItems.push_back("gymratdresser");
                    PurchasedItemSound();
                }
            }
        }
        ...
        if (isPurchased("animedresser") == false)
        {
            if (ImGui::Button("Anime Dresser 750$"))
            { 
                if (ECS.Get<EntityManager::Money>(0).price >= 750)
                {
                    ...
                    temp4 = "animedresser";
                    ECS.Get<EntityManager::Money>(0).price -= 750;
                    purchasedItems.push_back("animedresser");
                    PurchasedItemSound();
                }
            }
        }
    ...
    if (ImGui::BeginPopup("Floor-SubMenu"))
    {
        ...
        {
            if (ImGui::Button("Patriot-Floor 400$"))
            { // Shadai
        ...
        {
            if (ImGui::Button("Rich-B*****-Floor 495$"))
            { // Shadai
        ...
        {
            if (ImGui::Button("Gaming-Floor 480$"))
            { // Shadai
        ...
        {
            if (ImGui::Button("Rainbow-Floor 480$"))
            { // Shadai
                /*
        ...
        {
            if (ImGui::Button("Goth-Floor 485$"))
            { // Shadai
                /*
        ...
        {
            if (ImGui::Button("Halloween-Floor 500$"))
            { // Shadai
                /*
